...
<div class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="md:w-1/2 text-center md:text-left md:pr-8">
            <h1 class="text-4xl font-extrabold text-blue-600 mb-4">Welcome to Our Landing Page</h1>
            <p class="text-lg text-gray-700 mb-6">We are excited to have you here. Explore our website to learn more about what we offer and how we can help you achieve your goals.</p>
            <a href="#contact" class="bg-blue-500 text-white py-3 px-6 rounded-lg shadow-md hover:bg-blue-600 transition duration-300">Get Started</a>
        </div>
        <!-- Image Section -->
        <div class="md:w-1/2 mt-6 md:mt-0">
            <img src="{{ asset('assets/images/public.avif') }}" alt="Home Image" class="w-full max-w-md rounded-lg shadow-lg mx-auto">
        </div>
    </div>
</div>
