...
<div class="container mx-auto mt-10 px-4">
    <h1 class="text-5xl font-bold text-center mb-6 animate__animated animate__fadeIn animate__delay-1s" style="color: #990011;">Student Form</h1>

    <form action="/xyz" method="post" class="p-6 bg-white shadow-lg rounded-lg max-w-3xl mx-auto border border-gray-200 hover:shadow-2xl transition-shadow duration-300 ease-in-out">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <!-- Student Name -->
            <div>
                <label for="studentName" class="block text-gray-800 font-bold text-base mb-2 transition-colors duration-300 ease-in-out hover:text-blue-600">Student Name</label>
            ...
            <!-- Student Email -->
            <div>
                <label for="studentEmail" class="block text-gray-800 font-bold text-base mb-2 transition-colors duration-300 ease-in-out hover:text-blue-600">Student Email</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <!-- Student Password -->
            <div>
                <label for="studentPassword" class="block text-gray-800 font-bold text-base mb-2 transition-colors duration-300 ease-in-out hover:text-blue-600">Student Password</label>
            ...
            <!-- Student Number -->
            <div>
                <label for="studentNumber" class="block text-gray-800 font-bold text-base mb-2 transition-colors duration-300 ease-in-out hover:text-blue-600">Student Number</label>
        ...
        <!-- Student Address -->
        <div class="mb-6">
            <label for="studentAddress" class="block text-gray-800 font-bold text-base mb-2 transition-colors duration-300 ease-in-out hover:text-blue-600">Student Address</label>
